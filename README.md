...
* Click one of:
  * **Update** — installs the latest firmware while keeping all saved settings (WiFi credentials, screen-type detection, transport override, jog preferences, rotation). Use this for ALL firmware upgrades after the first install.
